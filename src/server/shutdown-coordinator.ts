...
import { collectActiveProjectTaskIds, collectProjectWorktreeTaskIdsForRemoval } from "./workspace-registry";
...
function collectWorkColumnTaskIds(workspaceState: RuntimeWorkspaceStateResponse): string[] {
	return Array.from(collectActiveProjectTaskIds(workspaceState.board));
}
