...
function collectTrackedTasks(board: RuntimeBoardData): TrackedTaskWorkspace[] {
	...
	for (const column of board.columns) {
		// Backlog, trash, and review cards do not need git metadata polling.
		// Tracking only active columns avoids unnecessary work: trash paths are
		// reconstructed from task id on the web-ui side, and review tasks are
		// finished — polling them would spawn persistent git subprocesses.
