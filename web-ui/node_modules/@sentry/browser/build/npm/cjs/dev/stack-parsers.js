...
const chromeStackParserFn = line => {
  ...
  if (noFnParts) {
    ...
    return createFrame(filename, browser.UNKNOWN_FUNCTION, +line, +col);
  }
...
const winjs = line => {
  ...
  return parts
    ? createFrame(parts[2], parts[1] || browser.UNKNOWN_FUNCTION, +parts[3], parts[4] ? +parts[4] : undefined)
    : undefined;
};
...
const opera10 = line => {
  ...
  return parts ? createFrame(parts[2], parts[3] || browser.UNKNOWN_FUNCTION, +parts[1]) : undefined;
};
...
const opera11 = line => {
  ...
  return parts ? createFrame(parts[5], parts[3] || parts[4] || browser.UNKNOWN_FUNCTION, +parts[1], +parts[2]) : undefined;
};
