		...
		<RadixPopover.Root open={open} onOpenChange={setOpen}>
			...
			<RadixPopover.Portal>
				<RadixPopover.Content
					...
					align="start"
					sideOffset={4}
					className="z-50 rounded-md border border-border bg-surface-2 p-1 shadow-lg kb-tooltip-show"
				>
								...
								selectedShortcut ? (
									<div className="flex">
										...
										<RadixPopover.Root>
											...
											<RadixPopover.Portal>
												<RadixPopover.Content
															className="z-50 rounded-lg border border-border bg-surface-2 p-1 shadow-xl kb-tooltip-show"
													sideOffset={5}
													align="end"
												>
